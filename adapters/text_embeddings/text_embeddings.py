...
class ModelAdapter(dl.BaseModelAdapter):
    ...
    def load(self, local_path, **kwargs):
        ...
        if not api_key:
            raise ValueError("Environment variable 'DATABRICKS_API_KEY' is not set. "
        ...
        if self.base_url == "<insert-dbrx-endpoint-url>":
            raise ValueError("Configuration error: 'base_url' must be replaced with your actual Databricks endpoint URL.") 
    ...
    def embed(self, batch, **kwargs):
        ...
        for item in batch:
            ...
            response = self.client.embeddings.create(
                ...
                encoding_format=self.model_entity.configuration.get('encoding_format', 'base64') # base64 is default
            )
