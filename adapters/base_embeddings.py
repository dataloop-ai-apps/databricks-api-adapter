...
class ModelAdapter(dl.BaseModelAdapter):
    ...
    def call_model(self, text):
        ...
        extra_headers = {"User-Agent": "integration/Dataloop", "Dtlpy-Model": f"{self.model_entity.name}/0.0.1"}
        ...
        response = self.client.embeddings.create(
            input=text, model=model_name, encoding_format=encoding_format, extra_headers=extra_headers
        )
